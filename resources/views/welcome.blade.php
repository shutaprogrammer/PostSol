    ...
    <head>
        ...
        <style>
            ...
            * { box-sizing: border-box; }
            ...
            .login { background-color: darkblue; color: #f3f4f6; }
            .register { background-color: #ef4444; color: #ffffff; }
            .title { font-size: 3rem; font-weight: 600; margin-bottom: 1.5rem; }
            .subtitle { font-size: 17px;, margin: 40px 20px; width: 70vw;}
            .smallh1{font-size: 40%}
            .sub{
                display: flex;
                flex-direction: row;
    ...
    <body>
        <div class="container">
            ...
            <div class="text-center">
                <h1 class="title">PostSol <span class="smallh1">~ 不満からビジネスへ ~</span></h1>
                <div class="sub"><p class="subtitle">不満を投稿してポイ活。不満からビジネスアイデアを思索。</p></div>
            </div>
        </div>
    </body>
</html>
