...
<body>
    ...
    <div>
        <p>返信までお時間がかかる場合ございます。ご了承いただけますと幸いです。</p>
        <p>目安：３〜５営業日</p>
    </div>
    <hr>
    
    <div class="d-grid gap-2 d-md-flex justify-content-md-center">
        <li id="link" style="list-style:none; display:flex; flex-direction:row; justify-content:center; align-content:space-between; ">
            <ul>
